          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow>
                <TableCell
                  colSpan={5}
                  className={`text-center py-8 text-muted-foreground ${lang === 'ar' ? 'text-right' : ''}`}
                >
                ...
                <TableRow key={offer._id}>
                  ...
                  <TableCell className={lang === 'ar' ? 'text-right' : ''}>
                    <span className="capitalize">
                      {offer.department?.[lang] || offer.department?.en || "N/A"}
                    </span>
                  </TableCell>
                  <TableCell className={lang === 'ar' ? 'text-right' : ''}>
                    <span className="capitalize">
                  ...
                  <TableCell className={lang === 'ar' ? 'text-right' : 'text-left'}>
                    <DropdownMenu>
